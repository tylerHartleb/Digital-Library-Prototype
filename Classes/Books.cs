...
namespace CPSC_481_Digital_Library_Prototype.Classes
{
    public class Books
    {
        ...
        private void CreateBookDict()
        {
            ...
            _books.Add("The Lightning Thief", lightningThief);
            ...
            _books.Add("Daughter of the Deep", daughterOfDeep);
            ...
            _books.Add("Around the World in Eighty Days", aroundWorldEightyDays);
            ...
            _books.Add("Journey to the Center of the Earth", journeyCenterEarth);
            ...
            _books.Add("A Study of History",studyOfHistory);
            ...
            _books.Add("Civilization on Trial", civOnTrial);
            ...
            _books.Add("Choose Life", chooseLife);
            ...
            _books.Add("The Making of the English Working Class", workingClass);
            ...
            _books.Add("Customs in Common", customsInCommon);
            ...
            _books.Add("Man's Search for Meaning", manMeaning);
            ...
            _books.Add("The Will to Meaning", willMeaning);
            ...
            _books.Add("Yes to Life: In Spite of Everything", yesLife);
            ...
            _books.Add("You Are a Badass: How to Stop Doubting Your Greatness and Start Living an Awesome Life", youBadass);
            ...
            _books.Add("Badass Habits: Cultivate the Awareness, Boundaries, and Daily Upgrades You Need to Make Them Stick", badassHabits);
            ...
            _books.Add("Cooking from the Spirit: Easy, Delicious, and Joyful Plant-Based Inspirations", cookFromSpirit);
            ...
            _books.Add("Feeding the Soul (Because It's My Business): Finding Our Way to Joy, Love, and Freedom", feedTheSoul);
            ...
            _books.Add("Seen, Loved and Heard: A Guided Journal for Feeding the Soul", seenLovedHeard);
            ...
            _books.Add("Ottolenghi Flavor: A Cookbook", ottoLenghi);
            ...
            _books.Add("Mezcla: Recipes to Excite", mezcla);
            ...
            _books.Add("Still Life: A Chief Inspector Gamache Novel", stillLife);
            ...
            _books.Add("A Fatal Grace", fatalGrace);
            ...
            _books.Add("A Rule Against Murder", ruleAgainstMurder);
            ...
            _books.Add("The Beast Must Die", beastMustDie);
            ...
            _books.Add("A Question of Proof", questionOfProof);
            ...
            _books.Add("A Game of Thrones", gameOfThrones);
            ...
            _books.Add("Fire & Bloods", fireAndBlood);
            ...
            _books.Add("A Dance with Dragons", danceOfDragons);
            ...
            _books.Add("The Name of the Wind", nameOfWind);
            ...
            _books.Add("TThe Wise Man's Fear", wiseManFear);
